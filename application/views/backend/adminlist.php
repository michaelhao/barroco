				...
				?>
					<tr>
						...
						<td id="right<?=$admin["id"]?>" class="right">
							<?php
							if($admin["right"] == 1){
								echo "<a href='###' class='btn btn-success rightCHK'><span class='icon-user-plus2'></span>正常</a>";
							} else {
								echo "<a href='###' class='btn btn-danger rightCHK'><span class='icon-user-cancel2'></span>停權</a>";
							}
							?>
						</td>
						<td>
