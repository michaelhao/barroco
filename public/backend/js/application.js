...
================================================== */
    ...
    oTable = $('.datatable-tools table').dataTable({
        ...
        // "sDom": '<"datatable-header"Tfl><"datatable-scroll"t><"datatable-footer"ip>',
        // 修改上下面都有切換頁面功能
        "sDom": '<"datatable-header"Tfl><"datatable-footer"ip><"datatable-scroll"t><"datatable-footer"ip>',
        "aaSorting": [
            [0, "desc"]
        ],
        // 修改上下面都有切換頁面功能
        "oLanguage": {
            "sSearch": "<span>查詢資料:</span> _INPUT_",
            "sLengthMenu": "<span>顯示筆數:</span> _MENU_",
            "oPaginate": {
                "sFirst": "最前",
                "sLast": "最後",
                "sNext": ">",
...
================================================== */
    ...
    $('.editor').wysihtml5({
        stylesheets: "public/css/wysihtml5/wysiwyg-color.css"
    });
