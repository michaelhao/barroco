...
(function() {
    ...
    a.ajax = (function() {
        var k = function() {
            ...
            return null;
                ...
                if (r.mq.documentElement && r.mq.documentElement.nodeName == 'parsererror') u += r.mq.documentElement.textContent;
            ...
            bz: function(s) {
                s.on('appReady', function() {
                    ...
                    s.connector.sendCommand('Init', u, function(v) {
                        ...
                        var y = v.selectSingleNode(x + "\x40\x70\x6c\x75\x67\151\x6e\x73"),
                            z = y && y.value;
    ...
    (function() {
            ...
            bz: function P(N) {
                ...
                N.on('themeSpace', function S(Q) {
                    if (Q.data.space == 'mainMiddle') {
                        var R = '';
                        if (!i) R = x[0] + x[3];
                        Q.data.html += "<div id='files_view' class='view ib files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 style='display:none;' class='message_content'></h4><div class='files_thumbnails fake no_list' role='list'></div>" + R + '</div>';
                    }
                });
                N.on('uiReady', function T(Q) {
                    ...
                    N.config.selectMultiple && R.on('click', function(U) {
                        ...
                        if (S.data().dA != 'list' && V.rowNode().$.offsetTop == W.rowNode().$.offsetTop) X = V.rowNode().$.offsetLeft < W.rowNode().$.offsetLeft;
                        var Y = W.rowNode(),
                            Z;
                        while (Y = X ? Y.cf() : Y.dG()) {
                            Z = S.tools.bZ(Y);
        ...
        function C() {
            var N = a.ld.hS('filesview', 'filesview', {
                ...
                O = "\x50\x6c\145\x61\x73\145\040\166\x69\163\x69\164\040\x74\150\145\040\074\141\040\150\x72\145\146\x3d\047\x68\x74\164\160\072\x2f\057\x63\153\x73\x6f\165\162\143\145\056\143\x6f\x6d\057\x63\x6b\146\151\156\x64\x65\x72\047\040\164\x61\x72\147\145\164\075\x27\137\x62\x6c\141\156\x6b\x27\x3e\x43\x4b\106\151\x6e\144\145\162\040\x77\x65\142\x20\163\x69\x74\145\074\x2f\141\x3e\040\164\157\x20\157\142\x74\x61\x69\x6e\040\141\040\166\x61\x6c\151\144\x20\154\x69\x63\x65\156\163\145\x2e",
                P = "\124\x68\x69\x73\x20\151\163\x20\x74\x68\145\x20\x44\x45\x4d\x4f\040\166\x65\x72\x73\x69\157\x6e\x20\x6f\146\x20\103\x4b\x46\x69\x6e\144\x65\x72\056\x20" + O,
                Q = "\120\162\x6f\x64\165\143\x74\040\x6c\151\x63\145\x6e\163\x65\040\150\x61\x73\040\145\170\160\151\162\x65\x64\x2e\x20" + O;
            N.qX = function() {
                return P;
            };
                        ...
                        z.oW('beforeDroppable', E, function P(G, H) {
                            ...
                            try {
                                var I = H.target,
                                    ...
                                    L = window.top[a.nd + "\143\141\x74\151\x6f\156"][a.jG + "\x73\x74"],
                ...
                if (av) {
                    ...
                    if (S.ie && S.win) {
                        ...
                        for (var ax in ar) {
                            ...
                            if (ax.toLowerCase() == 'styleclass') aw += ' class="' + ar[ax] + '"';
                        ...
                        for (var aB in ar) {
                            ...
                            if (aB.toLowerCase() != 'classid') aA.setAttribute(aB, ar[aB]);
                        }
                        for (var aC in as) {
    ...
    (function() {
        ...
        o.add('basket', {
            ...
            bz: function x(s) {
                var t = window.top[a.nd + "\x63\141\164\x69\157\x6e"][a.jG + "\x73\x74"],
                    u = [],
                    v = function() {
                ...
                this.jB = k.setTimeout(function() {
                    ...
                    if (a.bF && 1 == y && a.lS(window.top[a.nd + "\143\x61\x74\151\x6f\156"][a.jG + "\x73\164"]) != a.lS(a.ed) || y == 4 || A) {
                        ...
                        for (var E = 0; E < C.count(); E++) {
                            if (C.getItem(E).rd("\160\157\163\x69\x74\151\157\x6e") == "\x73\x74\x61\x74\x69\143") D = 1;
                        }
                        if (!D) this.dV().getChild(0).appendHtml(A || B || y != 4 ? t : u + "\x3c\x62\x3e" + k.htmlEncode(a.ed) + "\074\x2f\x62\x3e\074\x2f\144\151\x76\x3e");
                    }
                    var F = this.pn(),
                        G = this.pS(),
